...
class UserList$Type extends MessageType<UserList> {
  ...
  create(value?: PartialMessage<UserList>): UserList {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.data = [];
    if (value !== undefined) reflectionMergePartial<UserList>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class GetUserByEmailRequest$Type extends MessageType<GetUserByEmailRequest> {
  ...
  create(value?: PartialMessage<GetUserByEmailRequest>): GetUserByEmailRequest {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.email = '';
    if (value !== undefined) reflectionMergePartial<GetUserByEmailRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class GetUserRequest$Type extends MessageType<GetUserRequest> {
  ...
  create(value?: PartialMessage<GetUserRequest>): GetUserRequest {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.id = 0;
    if (value !== undefined) reflectionMergePartial<GetUserRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class GetUserResponse$Type extends MessageType<GetUserResponse> {
  constructor() {
    super('user.GetUserResponse', [{ no: 1, name: 'data', kind: 'message', T: () => User }]);
  }
  create(value?: PartialMessage<GetUserResponse>): GetUserResponse {
    const message = globalThis.Object.create(this.messagePrototype!);
    if (value !== undefined) reflectionMergePartial<GetUserResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class CreateUserResponse$Type extends MessageType<CreateUserResponse> {
  constructor() {
    super('user.CreateUserResponse', [{ no: 1, name: 'data', kind: 'message', T: () => User }]);
  }
...
class UpdateUserRequest$Type extends MessageType<UpdateUserRequest> {
  ...
  create(value?: PartialMessage<UpdateUserRequest>): UpdateUserRequest {
    const message = globalThis.Object.create(this.messagePrototype!);
    if (value !== undefined) reflectionMergePartial<UpdateUserRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(
    ...
    if (message.email !== undefined) writer.tag(3, WireType.LengthDelimited).string(message.email);
    const u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class UpdateUserResponse$Type extends MessageType<UpdateUserResponse> {
  ...
  create(value?: PartialMessage<UpdateUserResponse>): UpdateUserResponse {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.message = '';
    if (value !== undefined) reflectionMergePartial<UpdateUserResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
